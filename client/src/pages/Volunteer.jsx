...
function Volunteer() {
    ...
    const faqs = [
        {
            ...
            answer: "Simply fill out our volunteer application form above. Once submitted, our volunteer coordinator will reach out to you with next steps and available opportunities."
        },
        {
            question: "Do I need experience to volunteer for food rescue?",
            answer: "No prior experience is required! We provide all necessary training and guidance. All you need is enthusiasm and a willingness to help our community."
        },
        {
            question: "What time commitment is required?",
            answer: "We have flexible shifts ranging from 1-4 hours. You can volunteer as little or as often as your schedule allows."
        },
        {
            question: "Where do food rescue activities take place?",
            answer: "Activities take place throughout the Dayton, Ohio area including local grocery stores, restaurants, farms, and our distribution centers."
        },
        {
            question: "Can I volunteer as a group or with my company?",
            answer: "Absolutely! We welcome corporate groups, school clubs, faith organizations, and families. Contact us in advance to schedule a group volunteer session."
        },
        {
            question: "What should I wear as a food rescue volunteer?",
            answer: "Please wear closed-toe shoes and comfortable clothing that you don't mind getting a little dirty. We recommend layers as some activities are outdoors."
        },
        {
            question: "Do you offer community service hours for students?",
            answer: "Yes! We're happy to sign off on community service hours for students. Just let us know when you sign up."
        },
        {
            question: "Is there a background check required?",
            answer: "Background checks are only required for volunteers working directly with vulnerable populations or driving vehicles for food transport."
        },
        {
            question: "Can I volunteer if I have a full-time job?",
            answer: "Yes! Many of our volunteers work full-time. We offer evening and weekend opportunities to accommodate various schedules."
        },
        {
            question: "What if I can't commit to regular shifts?",
            answer: "That's perfectly fine! We welcome one-time volunteers and those who can only help occasionally. Every bit of help makes a difference."
        }
    ];
    ...
    return (
        <div className="animate-fade-in bg-white">
            ...
            <section className="px-6 md:px-8 py-20 md:py-28 bg-white">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <p className="text-base md:text-lg text-gray-600 max-w-2xl mx-auto leading-relaxed">
                        Join our mission to rescue surplus food and redistribute it to those in need. Every volunteer makes
                        a difference in fighting food waste and hunger in our community.
                    </p>
                </div>
            </section>
            ...
            <section id="volunteer-form" className="relative px-6 md:px-8 py-20 md:py-28 bg-pro-dark overflow-hidden">
                ...
                <div className="max-w-lg mx-auto relative z-10">
                    ...
                    <div className="bg-white rounded-2xl p-8 md:p-10 shadow-xl">
                        ...
                        <p className="text-sm text-center text-gray-500 mb-8 max-w-sm mx-auto">
                            Join our team of dedicated volunteers making a difference in the community. Help us rescue food and fight hunger together.
                        </p>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5">
                            ...
                            <div>
                                ...
                                >
                                    ...
                                    <option value="saturday-sunday-afternoons">Saturday–Sunday afternoons</option>
                ...
                <div className="max-w-4xl mx-auto">
                    <div className="text-center mb-12">
                        ...
                        <p className="text-base text-gray-600 max-w-xl mx-auto">
                            Have questions about volunteering? We've got answers. Find everything you need to know about joining our food rescue mission.
                        </p>
                    </div>
