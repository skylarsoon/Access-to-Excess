        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 md:px-8 w-full pt-20">
          <div className="max-w-xl">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-10 leading-[1.15]">
              Saving <span className="text-pro-light-green">Excess</span> food
              <br />& Increasing{" "}
              <span className="text-pro-light-green">Access</span> to it.
            </h1>
      ...
      <section className="px-4 md:px-8 py-24 bg-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-base md:text-lg text-gray-600 leading-relaxed max-w-2xl mx-auto">
            By reducing waste and strengthening community access, we help ensure
            good food reaches people, not landfills.
          </p>
        </div>
      </section>
